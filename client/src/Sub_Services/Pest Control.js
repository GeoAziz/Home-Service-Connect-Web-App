		...
		<div className="row">
			...
			<div className="row">
				<div className="col-lg-4 col-md-4 col-sm-4 text-center" data-aos="fade-left" data-aos-duration="2000">
					...
					<div className="maintenance text-center">PoaFix provides inspection and identification of bed bug infestations.</div>
					</div>
				</div>
				<div className="col-lg-4 col-md-4 col-sm-4 text-center" data-aos="fade-left" data-aos-duration="2000">
					<div className="p_10 text-center ">
				...
				<div className="col-lg-4  col-md-4 col-sm-4 text-center" data-aos="fade-left" data-aos-duration="2000">
					...
					<div className="maintenance text-center">PoaFix helps Safe removal of beehives and wasp nests.</div>
					</div>
				</div>
			</div>
		</div>
