    ...
    <>
      <div id="footer" className="footer-background">
            ...
            <Col lg={2}>
              <div className="footer-section" data-aos="fade-up" data-aos-duration="2000">
                ...
                <ul>
                  ...
                  <li><a href="/LI" className="text-white">LinkedIn</a></li>
        ...
        <div className="row justify-content-center">
          <div className="col-lg-1 mb-1 text-center" data-aos="fade-left" data-aos-duration="2000">
            <a href="https://www.instagram.com/your_instagram_username/" target="_blank" className="text-white" rel="noreferrer">
              <i className="fab fa-instagram fa-3x"></i>
            </a>
          </div>
          <div className="col-lg-1 mb-1 text-center" data-aos="fade-up" data-aos-duration="2000">
            <a href="https://www.facebook.com/your_facebook_username/" target="_blank" className="text-white" rel="noreferrer">
              <i className="fab fa-facebook fa-3x"></i>
            </a>
          </div>
          <div className="col-lg-1 mb-1 text-center" data-aos="fade-right" data-aos-duration="2000">
        ...
        <div className="divider">
          <footer className="footer">
            <br />
            <p className="text-white">&copy; 2024 PoaFix — All rights reserved</p>
          </footer>
        </div>
      </div>
    </>
